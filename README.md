...
| pfExtend | 1.0.5 | **[my fork](https://github.com/roby-brok/pfExtend)** — original by [Cliencer](https://github.com/Cliencer/pfExtend) and TinyStick. ⚠️ Heads up: while its QuestHelper browser is open it resets pfQuest's tracker and route whenever the list refreshes, so your tracked quests and current route disappear from under you. Not currently installed on my setup for that reason |
